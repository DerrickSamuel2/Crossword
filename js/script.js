...
// Updated: modern UI wiring — appends legend after plugin initializes
(function($) {
    $(function() {
        ...
        // Initialize the crossword plugin
        $('#puzzle-wrapper').crossword(puzzleData);

        // After the plugin injects #puzzle-clues, append the color legend
        // beneath the grid inside #puzzle-wrapper for context.
        // The plugin inserts #puzzle-clues as a sibling after #puzzle-wrapper,
        // so both live inside .puzzle-layout and flex correctly.
        var legend = [
            '<div class="puzzle-legend">',
            '  <span class="legend-item"><span class="legend-swatch legend-swatch--active"></span>Active word</span>',
            '  <span class="legend-item"><span class="legend-swatch legend-swatch--current"></span>Current cell</span>',
            '  <span class="legend-item"><span class="legend-swatch legend-swatch--done"></span>Solved word</span>',
            '  <span class="legend-item"><span class="legend-swatch legend-swatch--black"></span>Blocked cell</span>',
            '</div>'
        ].join('');

        $('#puzzle-wrapper').append(legend);
    });
